...
const examples: readonly Example[] = [
  ...
  },
  {
    id: 'error-bars',
    title: 'Error Bars',
    desc: 'Per-point high/low whiskers (type: errorBar) — HLC style; errorMode, capWidth, center markers',
    category: 'series',
  ...
  },
  {
    ...
    desc: 'Stairs via step on line/area (after/before/middle) — digital/step connection; mountain fill follows stepped top',
    category: 'series',
  ...
  },
  {
    ...
    desc: 'Vertical stems baseline→y (type: impulse) — optional markers; not errorBar',
    category: 'series',
