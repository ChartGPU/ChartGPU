...
- 🧊 **3D modality** (`coordinateSystem: 'cartesian3d'`) — world XYZ point clouds + uniform height-field surfaces with depth, orbit camera, and a separate render path (not 2D density/heatmap) — see [`docs/api/3d.md`](docs/api/3d.md), [`examples/point-cloud-3d/`](examples/point-cloud-3d/), [`examples/surface-3d/`](examples/surface-3d/)
