...
/**
 * Public ChartGPU.hitTest must return kind: 'impulse' for stem hits.
 */
...
describe('ChartGPU.hitTest — impulse', () => {
  ...
  it('returns kind: impulse on stem hit with tip value', async () => {
    // Full-bleed plot: domain x 0..2, y 0..20.
    // Sample at x=1, y=15, baseline=0 → stem through (1, 10).
